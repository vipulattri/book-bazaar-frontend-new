...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://book-bazaar-backend-new-1.onrender.com/api/auth/login", {
        method: "POST",
        headers: {
        ...
        <CardContent>
          ...
          <div className="mt-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button variant="outline" className="gap-2" disabled={isLoading} asChild>
                <a href="https://book-bazaar-backend-new-1.onrender.com/api/auth/google">
